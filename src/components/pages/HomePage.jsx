...
const HomePage = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center'>
      <section id="home" className={`flex md:flex-row flex-col py-10 `}>
        <div className={`flex justify-center items-center flex-col animate-[fadeInLeft_1s_ease-in-out] ss:w-1/2 px-10`}>
          <div className="flex flex-row justify-between items-center w-full h-[16rem]">
            <h1 className="flex font-poppins font-semibold text-4xl text-white text-gradient">
      ...
      {event&&<section id={'upcomingevents'} className={`flex flex-col w-[80%] justify-center items-center bg-zinc-800 rounded-2xl gap-5 p-5`} data-aos="fade-up" data-aos-duration='2000'>
        <div>
        ...
        <div className='flex sm:flex-row flex-col p-5 gap-5'>
          ...
          <div className={` grid grid-cols-2 grid-rows-3 justify-center flex-col w-full gap-5`} data-aos="fade-up-left" data-aos-duration='2000'>
            <div className='flex flex-col justify-center'>
              ...
              <span className={`font-poppins font-normal text-justify text-dimWhite text-xl `}>{event?.eventDate.slice(0,10).split('-').reverse().join('-')}</span>
            </div>
            <div className='flex flex-col justify-center'>
              <span className='flex font-semibold text-gradient text-2xl'>Venue:</span>
              <span className={`font-poppins font-normal text-justify text-dimWhite text-xl `}>{event?.venue}</span>
            </div>
            <div className='flex flex-col justify-center'>
              <span className='flex font-semibold text-gradient text-2xl'>Time:</span>
              <span className={`font-poppins font-normal text-justify text-dimWhite text-xl `}>{event?.time}</span>
            </div>
            <div className='flex flex-col justify-center'>
              <span className='flex font-semibold text-gradient text-2xl'>Speaker:</span>
              <span className={`font-poppins font-normal text-justify text-dimWhite text-xl truncate`}>{event?.speaker}</span>
            </div>
            <div className='flex flex-row col-span-2 cursor-pointer justify-start items-center gap-3' onClick={()=>{handleClick(event?.link)}}>
              <UilLink/>
              <span className={`font-poppins font-normal text-justify text-dimWhite text-xl text-gradient`}>See More</span>
            </div>
          </div>
        </div>
      ...
      <div className={`flex flex-col py-10 `}>
        ...
        <section id={'whatwedo'}className={`flex-1  flex-col xl:px-0 sm:px-16 px-6 `} data-aos="fade-up" data-aos-duration='2000'>
            <h1 className="flex-1 font-poppins font-semibold text-5xl text-gradient ">
              What We Do...
            </h1>
            <WhatWeDo/>
        </section>
        <section id={'achievements'} className={`flex-1 flex-col xl:px-0 sm:px-16 px-6 `} data-aos="fade-up" data-aos-duration='2000'>
            <h1 className="flex-1 font-poppins font-semibold text-5xl text-gradient ">
