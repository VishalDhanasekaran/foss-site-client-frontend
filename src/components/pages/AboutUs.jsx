...
const AboutUs = () => {
  return (
    <div className={`flex flex-col ${styles.paddingY}`}>
      ...
      <section id={'founders'} className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <h1 className="flex-1 font-poppins font-semibold ss:text-[52px] text-[32px] text-white ss:leading-[100.8px] leading-[75px]">
          Founders
        </h1>
        <p className={`${styles.paragraph} mt-5 text-justify`}>
      ...
      <section id={'community'} className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 mt-4`}>
