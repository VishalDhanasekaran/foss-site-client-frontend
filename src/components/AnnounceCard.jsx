...
const AnnounceCard = ({title,pic}) => {
  return (
    ...
    <div className='flex flex-col sm:w-full w-[90%] sm:h-full h-[90%] p-4 bg-black bg-opacity-80 backdrop-blur-sm rounded-lg hover:scale-[1.02] group duration-300 animate-[fadeInDown_1s_ease-in-out] justify-end items-center' >
