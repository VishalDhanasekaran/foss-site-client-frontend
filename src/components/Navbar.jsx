...
const Navbar = () => {
    ...
    return (
        <nav className='fixed z-999 self-center bg-black/40 backdrop-blur-md rounded-xl w-[90%] shadow-2xl flex justify-between items-center py-[.8rem] lg:py-[1rem] px-[1rem] lg:px-[4rem] top'>
