...
const GetStarted = ({text,link,target}) => {
  ...
  return (
    <div className={` justify-center items-center flex w-52 h-10 rounded-xl bg-black p-1 cursor-pointer hover:scale-105 ease-in-out duration-300`} onClick={handleClick}>
